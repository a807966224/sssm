...
<div class="bjui-pageHeader" style="background-color:#fff; border-bottom:none;">
    <div class="bs-callout bs-callout-warning">
        ...
        <p>这是一个自定义模板显示的datagrid示例，注意参数<code>tdTemplate、templateWidth、dialogFilterW</code> 。<a href="html/datagrid/datagrid-template-source.html" data-toggle="dialog" data-options="{id:'dialog-datagrid-source-js', width:1000, height:600, title:'查看Datagrid示例 - 自定义模板显示 - 源码'}">点击查看示例源码</a></p>
    </div>
</div>
