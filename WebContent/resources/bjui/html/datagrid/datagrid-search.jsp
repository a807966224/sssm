...
<form data-toggle="ajaxsearch" data-options="{searchDatagrid:$.CurrentNavtab.find('#datagrid-test-filter')}">
    <fieldset>
        ...
        <div style="margin:0; padding:1px 5px 5px;">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <button type="button" class="btn-blue" data-toggle="dialog" data-options="{url:'resources/bjui/html/datagrid/datagrid-search-source.jsp', id:'dialog-datagrid-search', width:1000, height:600, title:'查看Datagrid示例- 页头搜索、自定义编辑 - 源码'}">点击查看示例源码</button>
        </div>
    </fieldset>
</form>
</div>
<div class="bjui-pageContent">
    <table class="table table-bordered" id="datagrid-test-filter" data-toggle="datagrid" data-options="{
        ...
        editUrl: 'resources/bjui/html/datagrid/datagrid-edit.jsp?code={code}',
        paging: {pageSize:60},
